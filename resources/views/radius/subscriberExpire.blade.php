                        ...
                        <div class="card custom-card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="card-title">
                                    ALL EXPIRE SUBSCRIBER LIST
                                </div>
                                <div>
                                <a class="btn btn-primary btn-wave btn-sm" href ="/subscriber_add"><i class='bx bx-plus'></i> Add Subscriber</a>
...
// Destroy the existing DataTable instance (if exists)
              ...
              $('#datatable-basic').DataTable({
                            ...
                            "pageLength": 10,
                            "ajax": {
                                "url": baseUrl+"/subscriberexpire", // Replace with your API URL
                                "type": "GET",
                            ...
                            "columnDefs": [
                                ...
                                },
                                {
                                    ...
                                    "render": function(data, type, row, meta) {
                                        ...
                                        const diffMilliseconds = now - givenTime;
                                        ...
                                        return `
                                        <div class="btn-group"><button class="btn btn-danger btn-sm" style="font-size: .65rem;">${row.expiration}</button><button class="btn btn-danger-light btn-sm" style="font-size: .65rem;">${result} ago</button></div>
