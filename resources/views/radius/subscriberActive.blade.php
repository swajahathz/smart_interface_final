...
// Destroy the existing DataTable instance (if exists)
              ...
              $('#datatable-basic').DataTable({
                            ...
                            "pageLength": 10,
                            "ajax": {
                                "url": baseUrl+"/subscriberactive", // Replace with your API URL
                                "type": "GET",
...
const result = `${days} day${days !== 1 ? 's' : ''} ${hours} hour${hours !== 1 ? 's' : ''}`;
                                        ...
                                        return `
                                        <div class="btn-group"><button class="btn btn-success btn-sm" style="font-size: .65rem;">${row.expiration}</button><button class="btn btn-success-light btn-sm" style="font-size: .65rem;">${result} Left</button></div>
