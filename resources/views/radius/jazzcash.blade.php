            ...
            Your toast message here.
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <h1 class="page-title fw-semibold fs-18 mb-0">JazzCash Invoice List</h1>
                        <div class="ms-md-1 ms-0">
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">JazzCash Invoice List</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
$("#submitBtn").on('click', function() {
    ...
    if (!amount || isNaN(numAmount) || numAmount <= 0) {
        ...
        $.ajax({
            url: "https://partner.alburakinternet.net.pk/api/newradiusapi/jazzcash.php",
            type: "POST",
            data: {
                amount: amount,
...
function loadtable(){
    ...
    $('#datatable-basic').DataTable({
                            ...
                            "pageLength": 10,
                            "ajax": {
                                "url": "https://partner.alburakinternet.net.pk/api/newradiusapi/jazzcashlist.php?id="+user_name, // Replace with your API URL
                                "type": "GET",
                                "dataSrc": ""
                            },
                            "columns": [
