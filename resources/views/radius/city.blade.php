            ...
            Your toast message here.
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <h1 class="page-title fw-semibold fs-18 mb-0">CITY</h1>
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div>
                                <button type="button" class="btn btn-primary btn-wave btn-sm"  data-bs-effect="effect-flip-vertical" data-bs-toggle="modal" href="#modaldemo8"><i class='bx bx-plus'></i> Add City</button>
                                                ...
                                                <form id="city_form">
                                                    <div class="mb-2">
                                                        <label for="recipient-name"
                                                            class="col-form-label">City Name</label>
                                                        <input type="text" id="name" class="form-control form-control-sm" placeholder="Type City Name" required>
...
$('#datatable-basic').on('click', '.update', function() {
    ...
    let id = $(this).data("id");
            ...
            $.ajax({
            url: '/update_city/'+id, // Your API endpoint
...
$('#datatable-basic').on('click', '.alert-confirm', function() {
        ...
        Swal.fire({
            ...
            if (e.isConfirmed) {
                ...
                let id = $(this).data("id");
                $.ajax({
                    url: baseUrl+'/citydelete/'+id, // replace with your API URL
                    method: 'POST',
                    data: {
...
$('#city_form').on('submit', function (e) {
          ...
          $('#nas_form input, #nas_form button').prop('disabled', true);
            ...
            // Send AJAX request
            $.ajax({
                url: baseUrl+'/cityadd',  // Replace with your API endpoint
                type: 'POST',
                ...
                success: function (response) {
                    ...
                    if (response.status === 1) {
                        showToast("bg-success","City Added.",response.message)
                ...
                $('#city_form input, #city_form button').prop('disabled', false);
                $('#loadingBtn').hide();
                $('#submitBtn').show();
                 }
            });
...
$('#update_city_form').on('submit', function (e) {
            ...
            // Disable all inputs and buttons
          $('#update_city_form input, #update_city_form button').prop('disabled', true);
            $('#updateBtn').hide();
            $('#updateloadingBtn').show();
            ...
            // Send AJAX request
            $.ajax({
                url: baseUrl+'/cityupdate/'+id,  // Replace with your API endpoint
                type: 'POST',
                data: JSON.stringify(formData),
                contentType: 'application/json',
                headers: {
                ...
                success: function (response) {
                    ...
                    if (response.status === 1) {
                        showToast("bg-success","City Updated.",response.message)
                ...
                $('#update_city_form input, #update_city_form button').prop('disabled', false);
                $('#updateloadingBtn').hide();
                $('#updateBtn').show();
                 }
            });
    ...
    // Destroy the existing DataTable instance (if exists)
              ...
              $('#datatable-basic').DataTable({
                            ...
                            "pageLength": 10,
                            "ajax": {
                                "url": baseUrl+"/city", // Replace with your API URL
                                "type": "GET",
                            ...
                            "columnDefs": [
                                ...
                                },
                                {
                                    ...
                                    "render": function(data, type, row, meta) {
                                        return `
                                            <button type="button" data-id="${row.cty_id}" class="btn btn-warning btn-sm btn-wave update">Edit</button>
                                            <button type="button" data-id="${row.cty_id}" class="btn btn-danger btn-sm btn-wave alert-confirm">Delete</button>
                                        `;
                                    }
                                }
                            ],
