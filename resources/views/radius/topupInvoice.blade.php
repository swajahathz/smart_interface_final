            ...
            Your toast message here.
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <h1 class="page-title fw-semibold fs-18 mb-0">TOPUP INVOICES</h1>
                        <div class="ms-md-1 ms-0">
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Topup Invoices</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="card-titles" style="width: 100%;">
                                    <div class="row">
                                               <div class="col-sm-12 col-md-3 col-xl-3 mb-3 d-flex" style="">
                                                ...
                                                <div class="col-sm-12 col-md-2 col-xl-2 mb-3 mb-3 d-flex">
                                                    <div><label class="form-control">RECEVIER</label></div>
                                                            <div  style="width:100%">
                                                                <select id="manager" class="form-control">
                                                                     <option value="0">All</option>
                                                                @if(is_array($manager) && count($manager) > 0)
                                                                        @foreach($manager as $item)
                                                                            <option value="{{ $item['user_id'] }}">{{ $item['managername'] }}</b></option>
                                                                        @endforeach
                                                                    @else
...
$("#searchBtn").on('click',function(){
    ...
    load_datatable(id,sd,ed,type,manager);
              ...
              function load_datatable(id,sd,ed,type,manager){
    // Destroy the existing DataTable instance (if exists)
              ...
              $('#datatable-basic').DataTable({
                            ...
                            "ajax": {
                                "url": baseUrl+"/topupinvoice/"+id+"/"+sd+"/"+ed+"/"+type+"/"+manager, // Replace with your API URL
                                "type": "GET",
