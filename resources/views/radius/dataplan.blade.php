            ...
            Your toast message here.
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <h1 class="page-title fw-semibold fs-18 mb-0">DATA PLANS</h1>
                        <div class="ms-md-1 ms-0">
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Data Plan List</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div>
                                <button type="button" class="btn btn-primary btn-wave btn-sm"  data-bs-effect="effect-flip-vertical" data-bs-toggle="modal" href="#modaldemo8"><i class='bx bx-plus'></i> Add DATA PLAN</button>
                                <div class="modal fade" id="modaldemo8" tabindex="-1"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h6 class="modal-title" id="exampleModalLabel">Create Plan</h6>
                                                ...
                                                <form id="nas_form">
                                                    <div class="mb-2">
                                                        <label for="recipient-name"
                                                            class="col-form-label">PLAN Name</label>
                                                        <input type="text" id="name" class="form-control form-control-sm" placeholder="Type Plan Name" required>
                                                        <input type="hidden" id="token" value="{{ $token }}"/>
                                                    </div>
                                                    <div class="mb-2">
                                                        <label for="recipient-name"
                                                            class="col-form-label">Value in GB</label>
                                                        <input type="number" id="value" class="form-control form-control-sm" value="0" required>
                                                    </div>
                                                    <div class="mb-2">
                                                        <label for="recipient-name"
                                                            class="col-form-label">Price</label>
                                                        <input type="number" id="price" class="form-control form-control-sm" value="0" required>
                                                    </div>
                                ...
                                <div class="modal fade" id="update_modal" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h6 class="modal-title" id="exampleModalLabel">Update Data Plan</h6>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
...
$('#datatable-basic').on('click', '.update', function() {
    ...
    let id = $(this).data("id");
            ...
            $.ajax({
            url: '/update_qouta_plan_modal/'+id, // Your API endpoint
...
$('#datatable-basic').on('click', '.alert-confirm', function() {
        ...
        Swal.fire({
            ...
            if (e.isConfirmed) {
                ...
                let id = $(this).data("id");
                $.ajax({
                    url: baseUrl+'/qoutaservicedelete/'+id, // replace with your API URL
                    method: 'POST',
                    data: {
...
$('#nas_form').on('submit', function (e) {
          ...
          $('#nas_form input, #nas_form button').prop('disabled', true);
            ...
            // Send AJAX request
            $.ajax({
                url: baseUrl+'/qoutaserviceadd',  // Replace with your API endpoint
                type: 'POST',
                ...
                success: function (response) {
                    ...
                    if (response.status === 1) {
                        showToast("bg-success","Plan Added.",response.message)
...
$('#update_nas_form').on('submit', function (e) {
          ...
          $('#update_nas_form input, #update_nas_form button').prop('disabled', true);
            ...
            var id = $('#update_qouta_id').val();
            

            // Send AJAX request
            $.ajax({
                url: baseUrl+'/qoutaserviceupdate/'+id,  // Replace with your API endpoint
                type: 'POST',
                data: JSON.stringify(formData),
                contentType: 'application/json',
                headers: {
                ...
                success: function (response) {
                    ...
                    if (response.status === 1) {
                        showToast("bg-success","Plan Updated.",response.message)
    ...
    // Destroy the existing DataTable instance (if exists)
              ...
              $('#datatable-basic').DataTable({
                            ...
                            "pageLength": 10,
                            "ajax": {
                                "url": baseUrl+"/qoutaservice", // Replace with your API URL
                                "type": "GET",
                            ...
                            "columns": [
                                ...
                                "render": function(data, type, row, meta) {
                                        return `
                                            <button type="button" data-id="" class="btn btn-warning-light btn-sm btn-wave">
  ${ (row.value / 1024).toFixed(1) } GB
</button>
                            ...
                            "columnDefs": [
                                ...
                                },
                                {
                                    ...
                                    "render": function(data, type, row, meta) {
                                        return `
                                            <button type="button" data-id="${row.qouta_id}" class="btn btn-warning btn-sm btn-wave update">Edit</button>
                                            <button type="button" data-id="${row.qouta_id}" class="btn btn-danger btn-sm btn-wave alert-confirm">Delete</button>
                                        `;
                                    }
                                }
                            ],
