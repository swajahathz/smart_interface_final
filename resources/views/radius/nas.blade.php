            ...
            Your toast message here.
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <h1 class="page-title fw-semibold fs-18 mb-0">NAS CONFIGRATION</h1>
                        <div class="ms-md-1 ms-0">
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">NAS List</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div>
                                <button type="button" class="btn btn-primary btn-wave btn-sm"  data-bs-effect="effect-flip-vertical" data-bs-toggle="modal" href="#modaldemo8"><i class='bx bx-plus'></i> Add NAS</button>
                                            ...
                                            <div class="alert-container"></div>
                                                <form id="nas_form">
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <input type="text" id="apiusername" class="form-control form-control-sm" placeholder="Type API Username" required>
                                                    </div>
                                                    <div class="mb-2">
                                                        <label for="recipient-name"
                                                            class="col-form-label">API Password</label>
                                                        <input type="text" id="apipassword" class="form-control form-control-sm" placeholder="*********" required>
                                                    </div>
                                                    <div class="mb-2">
                                                        <label for="recipient-name"
                                                            class="col-form-label">API Port</label>
                                                        <input type="text" id="apiport" class="form-control form-control-sm" placeholder="XXXX" required>
                                                    </div>
...
$('#datatable-basic').on('click', '.alert-confirm', function() {
        ...
        Swal.fire({
            ...
            if (e.isConfirmed) {
                ...
                let id = $(this).data("id");
                $.ajax({
                    url: baseUrl+'/nasdelete/'+id, // replace with your API URL
                    method: 'POST',
                    data: {
...
$('#nas_form').on('submit', function (e) {
          ...
          $('#nas_form input, #nas_form button').prop('disabled', true);
            ...
            let formData = {
                ...
                api_username: $('#apiusername').val(),
                api_password: $('#apipassword').val(),
                api_port: $('#apiport').val(),
            };
...
$('#update_nas_form').on('submit', function (e) {
          ...
          $('#update_nas_form input, #update_nas_form button').prop('disabled', true);
            ...
            let formData = {
                ...
                api_username: $('#update_apiusername').val(),
                api_password: $('#update_apipassword').val(),
                api_port: $('#update_apiport').val(),
            };
    ...
    // Destroy the existing DataTable instance (if exists)
              ...
              $('#datatable-basic').DataTable({
                            ...
                            "pageLength": 10,
                            "ajax": {
                                "url": baseUrl+"/nas", // Replace with your API URL
                                "type": "GET",
