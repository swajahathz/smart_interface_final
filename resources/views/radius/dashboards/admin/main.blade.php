...
@section('content')
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div>
                            <p class="fw-semibold fs-18 mb-0">Welcome backs, {{ $firstname.' '.$lastname }} !</p>
                                                    ...
                                                    <div class="d-flex align-items-top justify-content-between">
                                                        ...
                                                        <div class="flex-fill">
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between mt-1">
                                                                ...
                                                                <div class="text-end">
                                                                    <p  id="percentageValue" class="mb-0 text-primary fw-semibold">100%</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="d-flex align-items-top justify-content-between">
                                                        ...
                                                        <div class="flex-fill">
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between mt-1">
                                                                ...
                                                                <div class="text-end">
                                                                    <p class="mb-0 text-success fw-semibold active_percnet">0%</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="d-flex align-items-top justify-content-between">
                                                        ...
                                                        <div class="flex-fill">
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between mt-1">
                                                                ...
                                                                <div class="text-end">
                                                                    <p class="mb-0 text-success fw-semibold expire_percnet">0%</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="d-flex align-items-top justify-content-between">
                                                        ...
                                                        <div class="flex-fill">
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between mt-1">
                                                                ...
                                                                <div class="text-end">
                                                                    <p class="mb-0 text-success fw-semibold disable_percnet">0%</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body p-0 overflow-hidden">
                                                        <div class="leads-source-chart d-flex align-items-center justify-content-center">
                                                            ...
                                                            <div class="lead-source-value">
                                                                <span class="spinner-border spinner-border-md align-middle spinner1" role="status" aria-hidden="true"></span>
                                                                <div class="online_area1" style="display:none;">
...
$('#lastmonthtopup')
    ...
    .text(Number(response.lastmonthtopup).toLocaleString('en-US', { minimumFractionDigits: 2 }));
                        ...
                        let total = response.total_users / 100;
                        let active_percnet = response.active_users / total;
                        let expire_percnet = response.expired_users / total;
                        let disable_percnet = response.disabled_users / total;
                        
                        
                        active_percnet = Math.round(active_percnet); 
                        expire_percnet = Math.round(expire_percnet);
                        disable_percnet = Math.round(disable_percnet);
    
                        $(".active_percnet").text(active_percnet + "%");
                        $(".expire_percnet").text(expire_percnet + "%");
