...
@section('error-body')
<body style="background: linear-gradient(178deg, #0890ea 0%, #ccccff 100%);">
@endsection
                    ...
                    @csrf
                        <div class="card custom-card">
                            <div class="card-body p-5">
                                ...
                                <p class="h5 fw-semibold mb-2 text-center"> <div class="mb-4" style="text-align:center;">{!! $domainSettings['logo'] !!}</div></p>
                                <div class="row gy-3">
                                    <div class="col-xl-12">
