...
<body >
@endsection
<div class="page error-bg" id="particles-js" style="background-color:#1d1052;">
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center authentication authentication-basic h-100">
                <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12" >
                    ...
                    @csrf
                        <div class="card custom-card" style="background: linear-gradient(181deg, #ffffff 0%, #ffffff 100%);
    border: 1px solid #e1e1e1;">
                 ...
                 <div class="mb-4" style="text-align:center;">{!! $domainSettings['logo'] !!}</div>
                                ...
                                @endif
                                <p class="h4 fw-semibold mb-2 text-center">Prime Network</p>
                                <div class="row gy-3">
                                    <div class="col-xl-12">
                                    ...
                                    <div class="col-xl-12 d-grid mt-2">
                                        <button type="submit" class="btn btn-lg text-white"  style="background-color:#1D1052; border-color:#1D1052;">Sign In</button>
                                    </div>
                                </div>
