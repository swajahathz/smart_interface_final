...
@section('error-body')
  ...
  ">
    <div style="
      width:100%; height:100%;
      background: url('https://partnerz.alburakinternet.net.pk/build/assets/images/background-sblink.jpg') center/cover no-repeat;
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center authentication authentication-basic h-100">
                ...
                @endif
                                ...
                                <div class="mt-2 text-center"><span style="font-size:10px;">Powered By</span><br>S.B Link Network</div>
