                                 ...
                                 <div class="card-titles">
                                    <div class="row">
                                               <div class="col-sm-12 col-xl-4 mb-3">
                                                        ...
                                                        <select class="form-select mb-4" name="ownername" id="manager">
...
function circle(percent,color,id){
   ...
   $.ajax({
                ...
                success: function (response) {
                  ...
                  let ownerSelect = $('#manager');
                    ownerSelect.empty(); // Remove old options
                    ownerSelect.append('<option value="" selected disabled>SELECT MANAGER</option>');
                    ownerSelect.append('<option value="0">All</option>');
            
                    $.each(response, function (index, item) {
                        ownerSelect.append('<option value="' + item.user_id + '">' + item.managername + ' | ' + item.actype + ' | ' + item.totaluser +' Subscriber</option>');
                    });
