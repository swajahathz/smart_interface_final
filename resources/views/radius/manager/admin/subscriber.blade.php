                        ...
                        <div class="card custom-card">
                             <div class="card-header" style="justify-content: center;">
                                <div class="card-titles d-flex">
                                    ...
                                    <div>
                                        <button id="searchBtn" class="btn btn-md btn-primary">Search</button>
                                    </div>
                                </div>
...
// Destroy the existing DataTable instance (if exists)
              ...
              $('#datatable-basic').DataTable({
                             ...
                             buttons: [
                                        {
                                            ...
                                            attr: {
                                                id: 'bulkdelete' // custom ID for JavaScript control
                                            }
                                        }
                                    ],
                            "pageLength": 10,
                            "ajax": {
                                "url": baseUrl+"/subscriber/"+manager+"/"+status+"/"+subscriber+"/"+service, // Replace with your API URL
                                "type": "GET",
                            ...
                            "columnDefs": [
                                {
                                    "targets": 1,  // Target the first column for serial number
                                    "searchable": false,
                                    "orderable": false,
                                    ...
                                    "render": function(data, type, row, meta) {
                                        ...
                                        return `
                                           <div class="d-flex align-items-center gap-1">
                                                                 ...
                                                                 <span class="badge bg-warning">${row.owner_name}</span>
                                                        </div>
                                        `;
                                    }
                                },
                                    ...
                                    "render": function(data, type, row, meta) {
                                        return `
                                             <div class="btn-list">
                                                            ...
                                                            <button class="btn btn-sm btn-danger-light btn-icon alert-confirm" data-id="${row.subscriber_id}"><i class="ri-delete-bin-line"></i></button>
                                                        </div>
                                        `;
                                    }
                                },
