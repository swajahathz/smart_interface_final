...
@endif
 ...
 {{ ucwords($manager['lastname']) }}
    ...
    padding: 10px 10px;
                                    ...
                                    <div class="border-bottom border-block-end-dashed d-flex justify-content-around" style="background-color: #f4f7ff;padding: 5px 0;">
                                        ...
                                        <div class="profile_boxs">
                                            <h6 class="fw-semibold mb-1">{{ $total_f }}</h6>
                                            <p class="mb-1 text-muted op-7">Franchise</p>
                                        </div>
                                        <div class="profile_boxs">
                                            <h6 class="fw-semibold mb-1 ">{{ $total_d }}</h6>
                                            <p class="mb-1 text-muted op-7">Dealer</p>
                                        </div>
                                        <div class="profile_boxs">
