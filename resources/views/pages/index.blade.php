                        ...
                        <div class="col-xxl-9 col-xl-9">
                            <div class="row">
                                <div class="col-xl-4">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card custom-card" style="background-color: #0158ff14;">
                                                        ...
                                                        <div class="flex-fill">
                                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                                <div>
                                                                    ...
                                                                    <h4 class="fw-semibold mt-1 fs-20">1,02,890</h4>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex align-items-center justify-content-between mt-1">
                                                                <div>
                                                                    <a class="text-primary fs-11" href="javascript:void(0);">View All<i class="ti ti-arrow-narrow-right ms-1 fw-semibold d-inline-block"></i></a>
                                                                </div>
                                                                <div class="text-end">
                                                                    <p class="mb-0 text-primary fw-semibold">40%</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="flex-fill">
                                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                                <div>
                                                                    ...
                                                                    <h4 class="fw-semibold mt-1 fs-20">80,689</h4>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex align-items-center justify-content-between mt-1">
                                                                <div>
                                                        ...
                                                        <div class="flex-fill">
                                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                                <div>
                                                                    ...
                                                                    <h4 class="fw-semibold mt-1 fs-20">20,090</h4>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex align-items-center justify-content-between mt-1">
                                                                <div>
                                                        ...
                                                        <div class="flex-fill">
                                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                                <div>
                                                                    ...
                                                                    <h4 class="fw-semibold mt-1 fs-20">60</h4>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex align-items-center justify-content-between mt-1">
                                                                <div>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-top justify-content-between">
                                                        ...
                                                        <div class="flex-fill ms-3">
                                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                                <div>
                                                                    <p class="text-muted mb-0">Total Topup</p>
                                                                    <h4 class="fw-semibold mt-1 fs-16">1,002,890</h4>
                                                                </div>
                                                        ...
                                                        <div class="flex-fill ms-3">
                                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                                <div>
                                                                    ...
                                                                    <h4 class="fw-semibold mt-1 fs-16">56,562</h4>
                                                                </div>
                                                    ...
                                                    <div class="row row-cols-12 border-top border-block-start-dashed">
                                                        <div class="col p-0">
                                                            <div class="ps-4 py-3 pe-3 text-center border-end border-inline-end-dashed">
                                                                ...
                                                                <div><span class="fs-14 fw-semibold">1,624</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col p-0">
                                                            <div class="p-3 text-center border-end border-inline-end-dashed">
                                                                ...
                                                                <div><span class="fs-14 fw-semibold">1,267</span></div>
                                                            </div>
                                                        </div>
                                                        <div class="col p-0">
                                                            <div class="p-3 text-center border-end border-inline-end-dashed">
                                                                ...
                                                                <div><span class="fs-14 fw-semibold">1,153</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col p-0">
                                                            <div class="p-3 text-center">
                                                                ...
                                                                <div><span class="fs-14 fw-semibold">679</span></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
