                                ...
                                <div class="tab-pane show active p-0 border-0" id="nft-all" role="tabpanel">
                                    <div class="row">
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                <img src="{{asset('build/assets/images/nft-images/18.png')}}" class="card-img-top" alt="...">
                                        ...
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                <img src="{{asset('build/assets/images/nft-images/19.png')}}" class="card-img-top" alt="...">
                                                <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                    <div class="flex-fill">
                                        ...
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                <img src="{{asset('build/assets/images/nft-images/20.png')}}" class="card-img-top" alt="...">
                                                <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                    <div class="flex-fill">
                                                        <button aria-label="button" type="button" class="btn btn-sm btn-icon btn-success rounded-pill btn-wave waves-effect waves-light">
                                                            <i class="ri-heart-fill"></i>
                                        ...
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                <img src="{{asset('build/assets/images/nft-images/21.png')}}" class="card-img-top" alt="...">
                                                <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                    <div class="flex-fill">
                                                        <button type="button" aria-label="button" class="btn btn-sm btn-icon btn-success rounded-pill btn-wave waves-effect waves-light">
                                                            <i class="ri-heart-fill"></i>
                                        ...
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                <img src="{{asset('build/assets/images/nft-images/22.png')}}" class="card-img-top" alt="...">
                                                <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                    <div class="flex-fill">
                                                        <button type="button" aria-label="button" class="btn btn-sm btn-icon btn-success rounded-pill btn-wave waves-effect waves-light">
                                                            <i class="ri-heart-fill"></i>
                                        ...
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                <img src="{{asset('build/assets/images/nft-images/23.png')}}" class="card-img-top" alt="...">
                                                <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                    <div class="flex-fill">
                                                        <button type="button" aria-label="button" class="btn btn-sm btn-icon btn-success rounded-pill btn-wave waves-effect waves-light">
                                                            <i class="ri-heart-fill"></i>
                                        ...
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                <img src="{{asset('build/assets/images/nft-images/24.png')}}" class="card-img-top" alt="...">
                                                <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                    <div class="flex-fill">
                                                        <button type="button" aria-label="button" class="btn btn-sm btn-icon btn-success rounded-pill btn-wave waves-effect waves-light">
                                                            <i class="ri-heart-fill"></i>
                                        ...
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                <img src="{{asset('build/assets/images/nft-images/25.png')}}" class="card-img-top" alt="...">
                                                <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                    <div class="flex-fill">
                                                        <button type="button" aria-label="button" class="btn btn-sm btn-icon btn-success rounded-pill btn-wave waves-effect waves-light">
                                                            <i class="ri-heart-fill"></i>
                                        ...
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                <img src="{{asset('build/assets/images/nft-images/26.png')}}" class="card-img-top" alt="...">
                                                <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                    <div class="flex-fill">
                                                        <button type="button" aria-label="button" class="btn btn-sm btn-icon btn-success rounded-pill btn-wave waves-effect waves-light">
                                                            <i class="ri-heart-fill"></i>
                                        ...
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                <img src="{{asset('build/assets/images/nft-images/27.png')}}" class="card-img-top" alt="...">
                                                <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                    <div class="flex-fill">
                                                        <button type="button" aria-label="button" class="btn btn-sm btn-icon btn-success rounded-pill btn-wave waves-effect waves-light">
                                                            <i class="ri-heart-fill"></i>
                                        ...
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                <img src="{{asset('build/assets/images/nft-images/28.png')}}" class="card-img-top" alt="...">
                                                <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                    <div class="flex-fill">
                                                        <button type="button" aria-label="button" class="btn btn-sm btn-icon btn-success rounded-pill btn-wave waves-effect waves-light">
                                                            <i class="ri-heart-fill"></i>
                                        ...
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                <img src="{{asset('build/assets/images/nft-images/29.png')}}" class="card-img-top" alt="...">
                                                <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                    <div class="flex-fill">
                                                        <button type="button" aria-label="button" class="btn btn-sm btn-icon btn-success rounded-pill btn-wave waves-effect waves-light">
                                                            <i class="ri-heart-fill"></i>
