                        ...
                        <div class="p-5">
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-xl-12 d-grid mt-2">
                                    <a href="{{url('signin-cover')}}" class="btn btn-lg btn-primary">Create</a>
                                </div>
                            </div>
                            <div class="text-center">
                                <p class="fs-12 text-muted mt-4">Already have an account? <a href="{{url('signin-cover')}}" class="text-primary">Sign In</a></p>
                            </div>
                        </div>
                    </div>
                </div>
