                            ...
                            <div class="row">
                                    ...
                                    <div class="card custom-card border">
                                        <div class="row g-0">
                                            <div class="col-md-3 col-4">
                                                <img src="{{asset('build/assets/images/media/jobs-landing/1.jpg')}}" class="img-fluid rounded-start h-100 browse-jobs-image" alt="...">
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="card custom-card border">
                                        <div class="row g-0">
                                            <div class="col-md-3 col-4">
                                                <img src="{{asset('build/assets/images/media/jobs-landing/2.jpg')}}" class="img-fluid rounded-start h-100 browse-jobs-image" alt="...">
                                            </div>
                                            <div class="col-md-9 col-8 my-auto">
                                                <div class="card-body">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="card custom-card border">
                                        <div class="row g-0">
                                            <div class="col-md-3 col-4">
                                                <img src="{{asset('build/assets/images/media/jobs-landing/3.jpg')}}" class="img-fluid rounded-start h-100 browse-jobs-image" alt="...">
                                            </div>
                                            <div class="col-md-9 col-8 my-auto">
                                                <div class="card-body">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="card custom-card border">
                                        <div class="row g-0">
                                            <div class="col-md-3 col-4">
                                                <img src="{{asset('build/assets/images/media/jobs-landing/4.jpg')}}" class="img-fluid rounded-start h-100 browse-jobs-image" alt="...">
                                            </div>
                                            <div class="col-md-9 col-8 my-auto">
                                                <div class="card-body">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="card custom-card border">
                                        <div class="row g-0">
                                            <div class="col-md-3 col-4">
                                                <img src="{{asset('build/assets/images/media/jobs-landing/5.jpg')}}" class="img-fluid rounded-start h-100 browse-jobs-image" alt="...">
                                            </div>
                                            <div class="col-md-9 col-8 my-auto">
                                                <div class="card-body">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="card custom-card border">
                                        <div class="row g-0">
                                            <div class="col-md-3 col-4">
                                                <img src="{{asset('build/assets/images/media/jobs-landing/6.jpg')}}" class="img-fluid rounded-start h-100 browse-jobs-image" alt="...">
                                            </div>
                                            <div class="col-md-9 col-8 my-auto">
                                                <div class="card-body">
                        ...
                        <div class="container">
                            ...
                            <div class="row row-cols-1 row-cols-md-3 g-4">
                                <div class="col">
                                    <div class="card custom-card border shadow-none">
                                        <a href="javascript:void(0);">
                                            <img src="{{asset('build/assets/images/media/jobs-landing/blog/1.jpg')}}" class="card-img-top" alt="...">
                                        </a>
                                        <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="card custom-card border shadow-none">
                                        <a href="javascript:void(0);">
                                            <img src="{{asset('build/assets/images/media/jobs-landing/blog/2.jpg')}}" class="card-img-top" alt="...">
                                        </a>
                                        <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="card custom-card border shadow-none">
                                        <a href="javascript:void(0);">
                                            <img src="{{asset('build/assets/images/media/jobs-landing/blog/3.jpg')}}" class="card-img-top" alt="...">
                                        </a>
                                        <div class="card-body">
