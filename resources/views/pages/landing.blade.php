                                ...
                                <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                    <div class="card custom-card text-center team-card ">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="mt-2">
                                                <a href="{{url('profile')}}" class="btn btn-light" target="_blank">View profile</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card custom-card overflow-hidden shadow-none">
                                <div class="card-body p-0">
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane show active p-0" id="pricing-monthly-pane"
                                        ...
                                        <div class="tab-pane p-0" id="pricing-yearly-pane"
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4 col-sm-6 col-12 mb-md-0 mb-3">
                                    <div class="px-4">
                                        <p class="fw-semibold mb-3"><a href="{{url('index')}}"><img src="{{asset('build/assets/images/brand-logos/desktop-dark.png')}}" alt=""></a></p>
