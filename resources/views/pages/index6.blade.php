                                ...
                                <div class="card-body p-0 customers">
                                    <ul class="list-group my-2">
                                        <li class="list-group-item border-0">
                                            <a href="javascript:void(0);" class="border-0">
                                                <div class="d-flex align-items-top">
                                                    <img class="avatar avatar-md me-3 my-auto" src="{{asset('build/assets/images/faces/2.jpg')}}" alt="Image description">
                                                    <div class="mt-0">
                                        ...
                                        <li class="list-group-item border-0 mb-2">
                                            <a href="javascript:void(0);" class="border-0">
                                                <div class="d-flex align-items-top">
                                                    <img class="avatar avatar-md me-3 my-auto" src="{{asset('build/assets/images/faces/1.jpg')}}" alt="Image description">
                                                    <div class="mt-0">
                                        ...
                                        <li class="list-group-item border-0 mb-2">
                                            <a href="javascript:void(0);" class="border-0">
                                                <div class="d-flex align-items-top">
                                                    <img class="avatar avatar-md me-3 my-auto" src="{{asset('build/assets/images/faces/5.jpg')}}" alt="Image description">
                                                    <div class="mt-0">
                                        ...
                                        <li class="list-group-item border-0 mb-2">
                                            <a href="javascript:void(0);" class="border-0">
                                                <div class="d-flex align-items-top">
                                                    <img class="avatar avatar-md me-3 my-auto" src="{{asset('build/assets/images/faces/7.jpg')}}" alt="Image description">
                                                    <div class="mt-0">
                                        ...
                                        <li class="list-group-item border-0 mb-2">
                                            <a href="javascript:void(0);" class="border-0">
                                                <div class="d-flex align-items-top">
                                                    <img class="avatar avatar-md me-3 my-auto" src="{{asset('build/assets/images/faces/9.jpg')}}" alt="Image description">
                                                    <div class="mt-0">
                                        ...
                                        <li class="list-group-item border-0">
                                            <a href="javascript:void(0);" class="border-0">
                                                <div class="d-flex align-items-top">
                                                    <img class="avatar avatar-md me-3 my-auto" src="{{asset('build/assets/images/faces/11.jpg')}}" alt="Image description">
                                                    <div class="mt-0">
                                                        <p class="mb-1 fw-semibold">Manuel Labor</p>
