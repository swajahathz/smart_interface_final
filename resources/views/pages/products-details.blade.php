                                                ...
                                                <div class="col-xl-4 mt-xxl-0 mt-3">
                                                    <div class="mb-5">
                                                        <div class="offer-promotion mb-4">
                                                            <div class="d-xxl-flex d-lg-block d-sm-flex flex-wrap justify-content-between align-items-center">
                                                                <div class="text-warning my-auto">Use Code <span class="promotion-code fw-semibold">FIRBUY</span><a class="fs-10 text-warning ms-1" href="javascript:void(0);">T&C.</a></div>
                                                                <div class="my-2">
                                                        ...
                                                        <div class="d-grid">
                                                            <a href="{{url('cart')}}" class="btn btn-primary mb-2">Add To Cart</a>
                                                            <a href="{{url('checkout')}}" class="btn btn-success mb-2">Buy Now</a>
                                                            <a href="{{url('wishlist')}}" class="btn btn-light">Add To Wishlist</a>
                                                        </div>
                                                    </div>
                                                    <div class="text-center">
                                                        <a href="javascript:void(0);">
                                                            <img src="{{asset('build/assets/images/ecommerce/png/25.png')}}" alt="" class="img-fluid rounded bg-light">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
