                                            ...
                                            <li class="list-group-item border-top-0 border-start-0 border-end-0">
                                                <div class="d-flex align-items-center flex-wrap">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="mb-0 fs-14 fw-semibold">$189 <span class="ms-1 text-muted fs-11"><s> $329</s></span></p>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="list-group-item  border-bottom border-block-end-dashed border-start-0 border-end-0">
                                                <div class="d-flex align-items-center flex-wrap">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="mb-0 fs-14 fw-semibold">$129 <span class="ms-1 text-muted fs-11"><s> $139</s></span></p>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
