                                                    ...
                                                    <div class="swiper swiper-preview-details bg-light product-details-page">
                                                        <div class="swiper-wrapper">
                                                            <div class="swiper-slide" id="img-container">
                                                                <img class="img-fluid" src="{{asset('build/assets/images/nft-images/32.png')}}" alt="img">
                                                            </div>
                                                            <div class="swiper-slide image-container">
                                                                <img class="img-fluid" src="{{asset('build/assets/images/nft-images/31.png')}}" alt="img">
                                                            </div>
                                                            <div class="swiper-slide image-container">
                                                                <img class="img-fluid" src="{{asset('build/assets/images/nft-images/30.png')}}" alt="img">
                                                            </div>
                                                            <div class="swiper-slide image-container">
                                                                <img class="img-fluid" src="{{asset('build/assets/images/nft-images/33.png')}}" alt="img">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="row mb-4">
                                                            <div class="col-xxl-3 col-xl-12">
                                                                ...
                                                                <p class="mb-1"><span class="h3"><span class="avatar avatar-sm avatar-rounded p-1 bg-light me-2"><img src="{{asset('build/assets/images/crypto-currencies/regular/Ethereum.svg')}}" alt=""></span>1.299<sup class="fs-14">.00</sup></span><span class="ms-3 badge bg-danger-transparent">50% Off</span></p>
                                                            ...
                                                            <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-xxl-0 mt-3">
                                                                ...
                                                                <div class="d-flex align-items-center fw-semibold">
                                                                    <span class="avatar avatar-xs avatar-rounded lh-1 me-1"><img src="{{asset('build/assets/images/faces/9.jpg')}}" alt=""></span>
                                                                    Json Taylor
                                                                </div>
                                                            </div>
