                                        ...
                                        <table class="table table-bordered text-nowrap">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('wishlist')}}" class="btn btn-icon btn-success me-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Wishlist"><i class="ri-heart-line"></i></a>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="p-3 d-grid">
                                        ...
                                        <a href="{{url('products')}}" class="btn btn-light btn-wave">Countinue Shopping</a>
                                    </div>
                                </div>
                            </div>
                        </div>
