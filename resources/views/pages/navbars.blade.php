...
@section('content')
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                            <h1 class="page-title fw-semibold fs-18 mb-0">Navbars</h1>
                                ...
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body">
                                        <nav class="navbar bg-light mb-3">
                                            <div class="container-fluid">
                                                <a class="navbar-brand" href="javascript:void(0);"><img src="{{asset('build/assets/images/brand-logos/toggle-logo.png')}}" alt=""></a>
                                            </div>
                                        </nav>
                            ...
                            <div class="col-xl-12">
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <nav class="navbar bg-light mb-3">
                                            <div class="container-fluid">
                                                <a class="navbar-brand"><img src="{{asset('build/assets/images/brand-logos/toggle-logo.png')}}" alt=""></a>
                                                <form class="d-flex" role="search">
                                                    <input class="form-control me-2" type="search" placeholder="Search"
                                                        aria-label="Search">
                                                    <button class="btn btn-primary" type="submit">Search</button>
                                ...
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <nav class="navbar navbar-expand-lg navbar-secondary mb-3">
                                            <div class="container-fluid">
                                                <a class="navbar-brand" href="javascript:void(0);"><img src="{{asset('build/assets/images/brand-logos/toggle-dark.png')}}" alt=""></a>
                                                <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
