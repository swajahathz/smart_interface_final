                                ...
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                        <div class="row kanban-board">
                                            <div class="col-xl-5">
                                                <button class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#add-board"><i class="ri-add-line me-1 d-inline-block fw-semibold align-middle"></i>New Board</button>
                                            </div>
                                ...
                                <div id="new-tasks-draggable" data-view-btn="new-tasks">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                <div class="d-flex text-muted justify-content-between mb-1 fs-12 fw-semibold">
                                                    <div><i class="ri-time-line me-1 align-middle"></i>Created - 28 May</div>
                                                    <div>2 days left</div>
                                                </div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div>
                                                        <a href="javascript:void(0);" class="me-2 text-primary">
                                                            <span class="me-1 d-inline-block"><i class="ri-thumb-up-fill align-middle fw-normal"></i></span><span class="fw-semibold fs-12">12</span>
                                                        </a>
                                                        <a href="javascript:void(0);" class="text-muted">
                                                            <span class="me-1 d-inline-block"><i class="ri-message-2-line align-middle fw-normal"></i></span><span class="fw-semibold fs-12">02</span>
                                                        </a>
                                                    </div>
                                                    <div class="avatar-list-stacked">
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                <div class="d-flex text-muted justify-content-between mb-1 fs-12 fw-semibold">
                                                    <div><i class="ri-time-line me-1 align-middle"></i>Created - 30 May</div>
                                                    <div>2 days left</div>
                                                </div>
                                                <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="p-3 border-top border-block-start-dashed">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div>
                                                        <a href="javascript:void(0);" class="me-2 text-primary">
                                                            <span class="me-1 d-inline-block"><i class="ri-thumb-up-fill align-middle fw-normal"></i></span><span class="fw-semibold fs-12">40</span>
                                                        </a>
                                                        <a href="javascript:void(0);" class="text-muted">
                                                            <span class="me-1 d-inline-block"><i class="ri-message-2-line align-middle fw-normal"></i></span><span class="fw-semibold fs-12">08</span>
                                                        </a>
                                                    </div>
                                                    <div class="avatar-list-stacked">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                <div class="d-flex text-muted justify-content-between mb-1 fs-12 fw-semibold">
                                                    <div><i class="ri-time-line me-1 align-middle"></i>Created - 02 Jun</div>
                                                    <div>1 days left</div>
                                                </div>
                                                <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="p-3 border-top border-block-start-dashed">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div>
                                                        <a href="javascript:void(0);" class="me-2 text-primary">
                                                            <span class="me-1 d-inline-block"><i class="ri-thumb-up-fill align-middle fw-normal"></i></span><span class="fw-semibold fs-12">16</span>
                                                        </a>
                                                        <a href="javascript:void(0);" class="text-muted">
                                                            <span class="me-1 d-inline-block"><i class="ri-message-2-line align-middle fw-normal"></i></span><span class="fw-semibold fs-12">28</span>
                                                        </a>
                                                    </div>
                                                    <div class="avatar-list-stacked">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                ...
                                <div id="todo-tasks-draggable" data-view-btn="todo-tasks">
                                    <div class="card custom-card">
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                <div class="d-flex text-muted justify-content-between mb-1 fs-12 fw-semibold">
                                                    <div><i class="ri-time-line me-1 align-middle"></i>Created - 01 Jun</div>
                                            ...
                                            <div class="p-3 border-top border-block-start-dashed">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div>
                                                        <a href="javascript:void(0);" class="me-2 text-primary">
                                                            <span class="me-1 d-inline-block"><i class="ri-thumb-up-fill align-middle fw-normal"></i></span><span class="fw-semibold fs-12">06</span>
                                                        </a>
                                                        <a href="javascript:void(0);" class="text-muted">
                                                            <span class="me-1 d-inline-block"><i class="ri-message-2-line align-middle fw-normal"></i></span><span class="fw-semibold fs-12">02</span>
                                                        </a>
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                <div class="d-flex text-muted justify-content-between mb-1 fs-12 fw-semibold">
                                                    <div><i class="ri-time-line me-1 align-middle"></i>Created - 05 Jun</div>
                                            ...
                                            <div class="p-3 border-top border-block-start-dashed">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div>
                                                        <a href="javascript:void(0);" class="me-2 text-primary">
                                                            <span class="me-1 d-inline-block"><i class="ri-thumb-up-fill align-middle fw-normal"></i></span><span class="fw-semibold fs-12">17</span>
                                                        </a>
                                                        <a href="javascript:void(0);" class="text-muted">
                                                            <span class="me-1 d-inline-block"><i class="ri-message-2-line align-middle fw-normal"></i></span><span class="fw-semibold fs-12">06</span>
                                                        </a>
                                                    </div>
                                                    <div class="avatar-list-stacked">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                ...
                                <div id="inprogress-tasks-draggable" data-view-btn="inprogress-tasks">
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="p-3 border-top border-block-start-dashed">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div>
                                                        <a href="javascript:void(0);" class="me-2 text-primary">
                                                            <span class="me-1 d-inline-block"><i class="ri-thumb-up-fill align-middle fw-normal"></i></span><span class="fw-semibold fs-12">05</span>
                                                        </a>
                                                        <a href="javascript:void(0);" class="text-muted">
                                                            <span class="me-1 d-inline-block"><i class="ri-message-2-line align-middle fw-normal"></i></span><span class="fw-semibold fs-12">13</span>
                                                        </a>
                                                    </div>
                                                    <div class="avatar-list-stacked">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                <div class="d-flex text-muted justify-content-between mb-1 fs-12 fw-semibold">
                                                    <div><i class="ri-time-line me-1 align-middle"></i>Created - 03 Jun</div>
                                            ...
                                            <div class="p-3 border-top border-block-start-dashed">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div>
                                                        <a href="javascript:void(0);" class="me-2 text-primary">
                                                            <span class="me-1 d-inline-block"><i class="ri-thumb-up-fill align-middle fw-normal"></i></span><span class="fw-semibold fs-12">02</span>
                                                        </a>
                                                        <a href="javascript:void(0);" class="text-muted">
                                                            <span class="me-1 d-inline-block"><i class="ri-message-2-line align-middle fw-normal"></i></span><span class="fw-semibold fs-12">0</span>
                                                        </a>
                                                    </div>
                                                    <div class="avatar-list-stacked">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="p-3 border-top border-block-start-dashed">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div>
                                                        <a href="javascript:void(0);" class="me-2 text-primary">
                                                            <span class="me-1 d-inline-block"><i class="ri-thumb-up-fill align-middle fw-normal"></i></span><span class="fw-semibold fs-12">09</span>
                                                        </a>
                                                        <a href="javascript:void(0);" class="text-muted">
                                                            <span class="me-1 d-inline-block"><i class="ri-message-2-line align-middle fw-normal"></i></span><span class="fw-semibold fs-12">35</span>
                                                        </a>
                                                    </div>
                                                    <div class="avatar-list-stacked">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                ...
                                <div id="completed-tasks-draggable" data-view-btn="completed-tasks">
                                    <div class="card custom-card">
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                <div class="d-flex text-muted justify-content-between mb-1 fs-12 fw-semibold">
                                                    <div><i class="ri-time-line me-1 align-middle"></i>Created - 12 Jun</div>
                                            ...
                                            <div class="p-3 border-top border-block-start-dashed">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div>
                                                        <a href="javascript:void(0);" class="me-2 text-primary">
                                                            <span class="me-1 d-inline-block"><i class="ri-thumb-up-fill align-middle fw-normal"></i></span><span class="fw-semibold fs-12">18</span>
                                                        </a>
                                                        <a href="javascript:void(0);" class="text-muted">
                                                            <span class="me-1 d-inline-block"><i class="ri-message-2-line align-middle fw-normal"></i></span><span class="fw-semibold fs-12">03</span>
                                                        </a>
                                                    </div>
                                                    <div class="avatar-list-stacked">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                <div class="d-flex text-muted justify-content-between mb-1 fs-12 fw-semibold">
                                                    <div><i class="ri-time-line me-1 align-middle"></i>Created - 10 Jun</div>
                                                    <div class="text-success"><i class="ri-check-fill me-1 align-middle d-inline-block"></i>Done</div>
                                                </div>
                                                <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="p-3 border-top border-block-start-dashed">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div>
                                                        <a href="javascript:void(0);" class="me-2 text-primary">
                                                            <span class="me-1 d-inline-block"><i class="ri-thumb-up-fill align-middle fw-normal"></i></span><span class="fw-semibold fs-12">22</span>
                                                        </a>
                                                        <a href="javascript:void(0);" class="text-muted">
                                                            <span class="me-1 d-inline-block"><i class="ri-message-2-line align-middle fw-normal"></i></span><span class="fw-semibold fs-12">12</span>
                                                        </a>
                                                    </div>
                                                    <div class="avatar-list-stacked">
                                                        <span class="avatar avatar-sm avatar-rounded">
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                <div class="d-flex text-muted justify-content-between mb-1 fs-12 fw-semibold">
                                                    <div><i class="ri-time-line me-1 align-middle"></i>Created - 07 Jun</div>
                                                    <div class="text-success"><i class="ri-check-fill me-1 align-middle d-inline-block"></i>Done</div>
                                                </div>
                                                <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="p-3 border-top border-block-start-dashed">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div>
                                                        <a href="javascript:void(0);" class="me-2 text-primary">
                                                            <span class="me-1 d-inline-block"><i class="ri-thumb-up-fill align-middle fw-normal"></i></span><span class="fw-semibold fs-12">11</span>
                                                        </a>
                                                        <a href="javascript:void(0);" class="text-muted">
                                                            <span class="me-1 d-inline-block"><i class="ri-message-2-line align-middle fw-normal"></i></span><span class="fw-semibold fs-12">05</span>
                                                        </a>
                                                    </div>
                                                    <div class="avatar-list-stacked">
                                                        <span class="avatar avatar-sm avatar-rounded">
...
@section('scripts')
        ...
        <!-- INTERNAL TASK-KANBAN DASHBOARD JS -->
