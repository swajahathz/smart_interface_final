                        ...
                        <div class="col-xl-9">
                            <div class="card custom-card">
                                <div class="card-header justify-content-between">
                                    ...
                                    <div>
                                        <a href="{{url('projects-create')}}" class="btn btn-sm btn-secondary btn-wave"><i class="ri-add-line align-middle me-1 fw-semibold"></i>Create Project</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <div class="d-sm-flex align-items-center lh-1">
                                        <div class="me-sm-3 mb-2 mb-sm-0">
                                            <img src="{{asset('build/assets/images/faces/9.jpg')}}" alt="" class="avatar avatar-md avatar-rounded">
                                        </div>
