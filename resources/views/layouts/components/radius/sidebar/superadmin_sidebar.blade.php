                ...
                <div class="main-sidebar" id="sidebar-scroll">
                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <ul class="main-menu">
                            ...
                            <li class="slide__category"><span class="category-name">Main Superadmin</span></li>
                            <!-- End::slide__category -->
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide">
                                        <a href="{{url('roles')}}" class="side-menu__item">Roles Level</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="slide has-sub">
                             ...
                             <!-- Start::slide__category -->
                             <li class="slide__category"><span class="category-name">Network Configration</span></li>
                            <!-- End::slide__category -->

                            <li class="slide">
                                <a href="{{url('nas')}}" class="side-menu__item">
                                <i class='bx bxs-user-detail side-menu__icon'></i>
                                    <span class="side-menu__label">Nas</span>
                                </a>
                            </li>
                            <li class="slide">
                                <a href="{{url('pool')}}" class="side-menu__item">
                                <i class='bx bxs-user-detail side-menu__icon'></i>
                                    <span class="side-menu__label">IP Pool</span>
                                </a>
                            </li>
                            <!-- <li class="slide">
                                <a href="{{url('policy')}}" class="side-menu__item">
                                <i class='bx bxs-user-detail side-menu__icon'></i>
                                    <span class="side-menu__label">Policy</span>
                                </a>
                            </li> -->
                            <li class="slide">
                                <a href="{{url('service')}}" class="side-menu__item">
                                <i class='bx bxs-user-detail side-menu__icon'></i>
                             ...
                             <!-- Start::slide__category -->
                             <li class="slide__category"><span class="category-name">User Account Info</span></li>
                            <!-- End::slide__category -->

                            <li class="slide">
                                <a href="{{url('roles')}}" class="side-menu__item">
                                    <i class='bx bx-list-ul side-menu__icon'></i>
                                    <span class="side-menu__label">Roles Level</span>
                                </a>
                            </li>

                            <li class="slide">
                                <a href="{{url('account')}}" class="side-menu__item">
                                <i class='bx bxs-user-detail side-menu__icon'></i>
                                    <span class="side-menu__label">Account List</span>
                                </a>
                            </li>
