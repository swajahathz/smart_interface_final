                ...
                <div class="main-sidebar" id="sidebar-scroll">
                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <ul class="main-menu">
                            ...
                            <li class="slide">
                                <a href="{{url('export')}}" class="side-menu__item">
                                <i class='bx bx-server side-menu__icon'></i>
                                    <span class="side-menu__label">Export Subscriber</span>
                                </a>
                            </li>
                    ...
                    @if ($apiUrll === 'https://rdsapi.smartispsolutions.net/api')
                            <li class="slide">
                                ...
                                <i class='bx bxs-report side-menu__icon'></i>
                                    <span class="side-menu__label">Rech. Invoices Details</span>
                                </a>
                            </li>
                            @endif
                            <li class="slide">
                            ...
                            <li class="slide">
                                ...
                                <i class='bx bxl-graphql side-menu__icon'></i>
 ...
 @php
                    ...
                    @if ($apiUrll === 'https://rdsapi.smartispsolutions.net/api')
                        <li class="slide">
                            ...
                            <li class="slide">
                                <a href="{{url('dplc')}}" class="side-menu__item">
                                <i class='bx bx-purchase-tag side-menu__icon'></i>
                                    <span class="side-menu__label">DPLC</span>
                                </a>
                            </li>
                    @endif
