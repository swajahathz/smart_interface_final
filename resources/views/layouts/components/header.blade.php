                        ...
                        <div class="header-element">
                            <div class="horizontal-logo">
                                <a href="{{url('dashboard')}}" class="header-logo">
                                    <img src="{{ $domainSettings['fav'] }}" alt="logo" class="desktop-logo">
                                    <img src="{{ $domainSettings['fav'] }}" alt="logo" class="toggle-logo">
                                    <img src="{{ $domainSettings['fav'] }}" alt="logo" class="desktop-dark">
                                    <img src="{{ $domainSettings['fav'] }}" alt="logo" class="toggle-dark">
                                    <img src="{{ $domainSettings['fav'] }}" alt="logo" class="desktop-white">
                                    <img src="{{ $domainSettings['fav'] }}" alt="logo" class="toggle-white">
                                </a>
                            </div>
                        </div>
                        <!-- End::header-element -->
                    ...
                    <div class="header-content-right">
                        ...
                        <div class="header-element country-selector d-none">
                            ...
                            <style>
                                ...
                                width: 100%;
                                height: 100%;
                                background-color: rgba(255,255,255,0.8); /* optional: white transparent background */
                                display: flex;
                        ...
                        @if(session('jump_username'))
                        
                         <div class="loadingGif" style="display:none;"><img src="/build/assets/images/jump2.gif"></div>
                            <div>
                                <button class="btn btn-primary btn-sm jump_back" style="margin: 1rem .65rem;">Back to Home</button>
                            </div>
                        ...
                        <div class="header-element header-search"> <!-- Start::header-link --> <a href="javascript:void(0);" class="header-link" data-bs-toggle="modal" data-bs-target="#searchModal"> <i class="bx bx-search-alt-2 header-link-icon"></i> </a> <!-- End::header-link --> </div>
                        ...
                        <div class="header-element">
                            ...
                            <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                <div class="d-flex align-items-center">
                                    <div class="me-sm-2 me-0">
                                        <img src="{{asset('build/assets/images/faces/9.png')}}" alt="img" width="32" height="32" class="rounded-circle">
                                    </div>
                                    <div class="d-sm-block d-none">
                                        <p class="fw-semibold mb-0 lh-1">@if ($roles_id == 1)
                                                Superadmin
                                            @elseif ($roles_id == 2)
                                                Admin
                                            @elseif ($roles_id == 3)
                                            ...
                                            @elseif ($roles_id == 6)
                                                Junior Dealer
                                            @endif</p>
                                        <span class="op-7 fw-normal d-block fs-11">{{$user_name}}</span>
                                    </div>
                                </div>
                            </a>
                            <!-- End::header-link|dropdown-toggle -->
                            <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                                ...
                                <!--<li><a class="dropdown-item d-flex border-block-end" href="javascript:void(0);"><i class="ti ti-wallet fs-18 me-2 op-7"></i>Bal: 10000</a></li>-->
                                <!--<li><a class="dropdown-item d-flex" href="{{url('chat')}}"><i class="ti ti-headset fs-18 me-2 op-7"></i>Support</a></li>-->
                                <li><a class="dropdown-item d-flex" href="{{url('logout')}}"><i class="ti ti-logout fs-18 me-2 op-7"></i>Log Out</a></li>
                            </ul>
                        </div>  
                        <!-- End::header-element -->
                        ...
                        <div class="header-element">
                           ...
                           <a href="{{ url('setting') }}" class="header-link switcher-icon">
